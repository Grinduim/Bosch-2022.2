...
def predict(image_path, yolov3, noise=False):
    net_h, net_w = 416, 416
...
#        image = sp_noise(image, 0.01)
    ...
    cv2.imshow("image detected", (image).astype('uint8'))
    cv2.waitKey(0)


weights_path = "yolov3.weights"

yolov3 = _build_model(weights_path)

# preprocess the image
image_path1 = "images/catdog.jpg"
image_path2 = "images/catdog_2.jpg"
image_path3 = "images/dog.jfif"
image_path4 = "images/pizza_pie.jpg"
image_path5 = "images/pizza.jpg"
image_path6 = "images/000042.jpg"
image_path7 = "images/Annotation 2022-04-28 142633.png"
image_path8 = "images/MG_5961.jpg"
image=cv2.imread(image_path1)
#image=cv2.GaussianBlur(image,(9,9),3)
#image=sp_noise(image,0.01)
#cv2.imshow("imagemGaussian", image)
#cv2.waitKey(0)
start=time.time()
predict(image_path8, yolov3, noise=False)
